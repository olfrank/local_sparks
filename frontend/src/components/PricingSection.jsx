    ...
    <section id="pricing" className="section-padding relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-lg mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          className="glass-card rounded-2xl border border-border/70 bg-surface/60 backdrop-blur-xl overflow-hidden"
        >
          {/* Price header */}
          <div className="px-6 pt-8 pb-6 md:px-8 md:pt-10 text-center border-b border-border/50">
            <div className="flex items-end justify-center gap-2 mb-2">
              <span style={{textShadow: "0px 0px 9px #64fb8cb0"}} className="text-[80px] md:text-[96px] font-bold text-[#64fb8d] leading-none tracking-tight">
                £59
              </span>
            ...
            <ul className="space-y-3.5">
              {included.map((item) => (
                <li key={item} className="flex items-start gap-3">
                  ...
                  <span className="text-sm text-text/85 leading-snug">{item}</span>
                </li>
              ))}
            </ul>
            ...
            <div className="mt-6 space-y-3">
              ...
              <p className="text-center">
                <button
                  ...
                  className="cg-label inline-flex items-center gap-1 text-sm text-muted hover:text-text transition-colors"
                >
                  Try the demo first

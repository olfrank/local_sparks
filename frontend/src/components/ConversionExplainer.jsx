            ...
            <div className="bg-gradient-to-br from-slate-700 to-slate-800 rounded-2xl p-8 border border-slate-600">
              ...
              <div className="space-y-6">
                <div className="flex justify-between items-center pb-4 border-b border-slate-600">
                  <span className="text-slate-300">Increase in phone calls</span>
                  <span className="text-3xl font-bold text-green-400">+40%</span>
                </div>
                <div className="flex justify-between items-center pb-4 border-b border-slate-600">
                  <span className="text-slate-300">Mobile conversion rate</span>
                  <span className="text-3xl font-bold text-green-400">3.2x</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-slate-300">Page load time</span>
                  <span className="text-3xl font-bold text-blue-400">&lt;2s</span>
                </div>
              </div>

              <p className="mt-6 text-sm text-slate-400">
                *Based on average improvements for similar trade businesses
              </p>
            </div>
